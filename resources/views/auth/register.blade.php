                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="text-center auth-logo-text">
                                <h4 class="mt-0 mb-3 mt-5">Free Register for Skill Test Ceylon Linux</h4>
                                <p class="text-muted mb-0">Get your free Skill Admin account now.</p>
                            </div>
                            <!--end auth-logo-text-->


                            <form class="form-horizontal auth-form my-4" action="{{route('register')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="custom-control custom-switch switch-success">
                                            ...
                                            <label class="custom-control-label text-muted" for="customSwitchSuccess">By
                                                registering you agree to the Frogetor
